...
public class HotelDataTest {
	...
	public void testAddInvalidReview() {
		...
		hdata.addReview("0007", "x78741", 4, "Bad review", "Hotel was not clean", false, "2016-09-05", "Jason");
		String expected = ""; // toString("0007") should return an empty string
							  // since a hotel with this id was never added to the
							 // hotel data
		// System.out.println(hdata.toString());
		
		Assert.assertEquals(String.format("%n" + "Test Case: %s%n", testName), expected, hdata.toString("0007").trim());
	}
	...
	public void testGetHotels() {
		...
		HotelData hdata = new HotelData();
		hdata.loadHotelInfo("input/hotels200.json");
